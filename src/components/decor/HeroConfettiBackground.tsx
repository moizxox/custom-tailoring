...
/** Hero background — konfetti with Fasnacht figure sketches on each side */
export function HeroConfettiBackground({ className }: HeroConfettiBackgroundProps) {
  return (
    <div className={cn("absolute inset-0 overflow-hidden pointer-events-none select-none bg-offwhite-warm", className)} aria-hidden>
      ...
      <div className="absolute left-[-80px] top-1/2 -translate-y-1/2 -translate-x-[18%] w-[min(52vw,700px)] aspect-[3/5] opacity-[0.2] [mask-image:linear-gradient(to_right,black_58%,transparent_80%)] [-webkit-mask-image:linear-gradient(to_right,black_58%,transparent_80%)]">
        <Image
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-[18%] w-[min(52vw,700px)] aspect-[3/5] opacity-[0.2] [mask-image:linear-gradient(to_left,black_58%,transparent_80%)] [-webkit-mask-image:linear-gradient(to_left,black_58%,transparent_80%)]">
        <Image
