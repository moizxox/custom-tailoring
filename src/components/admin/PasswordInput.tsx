  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full px-3.5 py-2.5 pr-12 border border-gray-300 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-periwinkle-500 focus:border-transparent transition"
