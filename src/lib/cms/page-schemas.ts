  ...
  },
  {
    ...
    sections: [
      { key: "hero", label: "Hero section", fields: pageHeroFields() },
      {
        ...
        description: "All row labels below are editable (German wording).",
        fields: [
          { key: "sectionTitle", label: "Block heading (optional)", type: "text", hint: "Leave empty to hide" },
          { key: "nameLabel", label: "Label — company name", type: "text", hint: 'e.g. "Firmenname"' },
          { key: "name", label: "Company name (value)", type: "text" },
          { key: "ownerLabel", label: "Label — management / owner", type: "text", hint: 'e.g. "Geschäftsführung" (not Inhaberin for an AG)' },
          { key: "owner", label: "Management / owner (value, optional)", type: "text", hint: "Leave empty to hide this row" },
          { key: "locationLabel", label: "Label — main location", type: "text" },
          { key: "address", label: "Street address", type: "text" },
          { key: "city", label: "City / ZIP", type: "text" },
          { key: "country", label: "Country", type: "text" },
          { key: "secondLocationLabel", label: "Label — second location", type: "text" },
          { key: "secondLocation", label: "Second location (value)", type: "text" },
          { key: "phoneLabel", label: "Label — phone", type: "text" },
          { key: "phone", label: "Phone", type: "text" },
          { key: "phoneHref", label: "Phone link", type: "url" },
          { key: "emailLabel", label: "Label — email", type: "text" },
          { key: "email", label: "Email", type: "text" },
          { key: "companyIdLabel", label: "Label — company ID", type: "text" },
          { key: "companyId", label: "Company ID", type: "text" },
          { key: "vatIdLabel", label: "Label — VAT ID", type: "text" },
          { key: "vatId", label: "VAT ID", type: "text" },
          { key: "purposeLabel", label: "Label — company purpose", type: "text" },
...
/** Schema for admin-created pages at /[slug] — shared Flex-Bausteine pool. */
