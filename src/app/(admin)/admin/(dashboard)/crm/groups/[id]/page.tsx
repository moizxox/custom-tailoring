  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl">
      <div className="flex items-center gap-2 mb-6">
        <Link href="/admin/crm/groups" className="text-xs text-gray-500 hover:text-white transition-colors">
          Gruppen
        </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="lg:col-span-2 bg-gray-900 border border-white/5 rounded-2xl p-5">
          <h2 className="text-sm font-semibold text-white mb-4">Gruppendetails</h2>
          <GroupForm
            groupId={group.id}
            initialData={{
              name: group.name,
          ...
          <div className="bg-gray-900 border border-white/5 rounded-2xl p-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white font-medium">{group.projects.length}</span>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-2">
                {group.projects.map((p) => (
                  <Link
                    ...
                    className="block text-sm text-gray-300 hover:text-violet-300 transition-colors"
                  >
                    {p.title}
                  </Link>
                ))}
